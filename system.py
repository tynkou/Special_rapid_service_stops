...
"加古川","西明石","明石","神戸","三ノ宮","芦屋","尼崎","大阪","新大阪","高槻","京都","山科","大津","石山","南草津",
"草津","守山","野洲","近江八幡","能登川","彦根","米原","坂田","田村","長浜","虎姫","河毛","高月","木ノ本","余呉",
"近江塩津","新疋田","敦賀","大津京","比叡山坂本","堅田","近江舞子","北小松","近江高島","安曇川","新旭","近江今津",
"近江中庄","マキノ","永原"]
...
def result():
    try:
        ...
        session.clear()
        return render_template("result.html",score=score,no_answerd=not_ans)
    except KeyError:
        return redirect(url_for("index"))
